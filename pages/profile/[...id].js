...
const Profile = ({ userData }) => {
  ...
  return (
    <>
      <div>
        <div className="flex sm:flex-row flex-col gap-6 justify-evenly bg-blue-50 rounded-md p-10">
          ...
          <div>
            ...
            <Link href={`/profile/update/${profileData?._id}`}>
              <button className="bg-blue-200 p-2 w-[100%] my-7  rounded-md hover:bg-blue-100">
                Update
              </button>
            </Link>{" "}
          </div>
