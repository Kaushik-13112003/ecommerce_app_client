...
export default async function checkOut(req, res) {
  ...
  try {
    ...
    const successUrl = products?.singleProduct
      ? `https://ecommercefront-h2h6bm3w0-kaushiks-projects-611a0910.vercel.app/purchase?success=true`
      : `https://ecommercefront-h2h6bm3w0-kaushiks-projects-611a0910.vercel.app/cartpayment?success=true`;
    const cancelUrl = products?.singleProduct
      ? `https://ecommercefront-h2h6bm3w0-kaushiks-projects-611a0910.vercel.app/purchase?success=false`
      : `https://ecommercefront-h2h6bm3w0-kaushiks-projects-611a0910.vercel.app/cartpayment?success=false`;
