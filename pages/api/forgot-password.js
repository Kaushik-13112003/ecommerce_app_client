    ...
    if (setUserToken) {
      const mailOptions = {
        ...
        html: `
         ...
         <a href=https://ecommercefront-h2h6bm3w0-kaushiks-projects-611a0910.vercel.app/reset-password/${setUserToken?._id}/${setUserToken?.verifyToken}> Click here to reset password </a>
