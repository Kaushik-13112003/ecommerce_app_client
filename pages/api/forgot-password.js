    ...
    if (token) {
      ...
      if (addTokenToUserData) {
        const mailOptions = {
         ...
         <a href="https://ecommercefront-5ugu9938z-kaushiks-projects-611a0910.vercel.app/reset-password/${isExist?._id}/${addTokenToUserData?.verifyToken}"> Click here to reset password </a>
