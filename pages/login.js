      ...
      let loginPromise = new Promise(async (resolve, reject) => {
        ...
        if (res.ok) {
          ...
          localStorage.setItem(
            "ecom-user-auth",
            JSON.stringify(dataFromResponse)
          );
          // router.push("/login");
    ...
    <>
      <div className=" bg-blue-50 p-3">
        ...
        <div className="flex  items-center justify-center p-7">
          <form
            className="bg-blue-100 rounded-md p-5 md:w-[50%] sm:w-[70%] w-[90%] flex gap-6 flex-col"
          ...
          >
            ...
            <button className="bg-blue-200 p-2 w-[100%] mb-5 rounded-md hover:bg-blue-50">
              Login
            </button>
          </form>
        </div>
